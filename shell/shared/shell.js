...
if (Meteor.isClient) {
  ...
  Meteor.startup(function () {
    ...
    console.log(
      "%cApp authors: to debug an app, make sure you execute Javascript " +
        ...
        "\n" +
        "\nTo learn about the grain-frame in Sandstorm and how to find logs and perform troubleshooting, see: " +
        "\n" +
