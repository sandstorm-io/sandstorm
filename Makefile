...
bin/spk bin/sandstorm-http-bridge bin/sandstorm bin/minibox: tmp/.ekam-run
	@test -e "$@"
	@touch "$@"
...
bundle: bin/spk bin/minibox bin/sandstorm-http-bridge bin/sandstorm shell-build make-bundle.sh
	$(call color,bundle)
	@./make-bundle.sh
