...
Template.sandstormAppDetailsPage.events({
  ...
  "click .uninstall-button": function (evt) {
    const ref = Template.instance().data;
    const db = ref._db;
