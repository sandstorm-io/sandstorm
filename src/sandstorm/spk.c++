...
private:
  ...
  kj::MainBuilder::Validity doInit() {
    ...
    auto content = kj::str(
        ...
        "      # for purposes like marketing and display.  For details on any of these fields\n"
        "      # consult Metadata in\n"
        "      # https://github.com/sandstorm-io/sandstorm/blob/master/src/sandstorm/package.capnp\n"
        "      icons = (\n"
        "        # Various icons to represent the app in various contexts.\n"
        "        appGrid = (svg = embed \"path/to/128x128.svg\"),\n"
        "        grain = (svg = embed \"path/to/24x24.svg\"),\n"
        "        market = (svg = embed \"path/to/150x150.svg\"),\n"
        "        marketBig = (svg = embed \"path/to/300x300.svg\"),\n"
        "      ),\n"
        ...
        "      license = (none = void),\n"
        "      # The license this package is distributed under.\n"
        "      categories = [],\n"
        "      # A list of categories/genres to which this app belongs, sorted with best fit first.\n"
        "      # See the list of categories in\n"
        "      # https://github.com/sandstorm-io/sandstorm/blob/master/src/sandstorm/package.capnp\n"
        "      author = (\n"
        ...
        : "  fileList = \"sandstorm-files.list\",\n"
          ...
          "  #  # sense for your app.\n"
          "  #  # For more detailed information, see \"BridgeConfig\" in\n"
          "  #  # https://github.com/sandstorm-io/sandstorm/blob/master/src/sandstorm/package.capnp\n"
          "  #  viewInfo = (\n"
          ...
          "  #        verbPhrase = (defaultText = \"can change site settings\"),\n"
          "  #        # Brief explanatory text to show in the sharing UI indicating\n"
          "  #        # what a user assigned this role will be able to do with the grain.\n"
          "  #        description = (defaultText = \"admins may view all site data and change settings.\"),\n"
          "  #        # Prose describing what this role means, suitable for a tool tip or similar help text.\n"
          "  #      ),\n"
          "  #    ],\n"
          "  #  ),\n"
